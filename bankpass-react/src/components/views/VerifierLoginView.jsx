...
export default function VerifierLoginView({ next, goHome }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="glass-card max-w-md w-full p-10 pb-16 text-center animate-[slideUp_0.6s_cubic-bezier(0.16,1,0.3,1)] relative">
        <div className="w-16 h-16 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-blue-500/30">
          <i className="fa-solid fa-shield-halved text-3xl text-blue-400"></i>
        </div>
        
        <h2 className="text-3xl font-bold text-white mb-2">Verifier Login</h2>
        ...
        <div className="space-y-4 text-left">
          ...
          <button
            onClick={handleLogin}
            className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-semibold py-3 rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:-translate-y-0.5 transition-all mt-6"
          >
            Login
          </button>
        </div>
